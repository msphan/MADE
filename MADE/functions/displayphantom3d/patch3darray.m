function [varargout] = patch3darray(varargin)
...
%       set(hpat{loopJ},'EdgeColor',cmap(loopJ,:)/2);%,'EdgeAlpha',0.1);
      set(hpat{loopJ},'EdgeColor','none');
...
%     set(hpat,'EdgeColor',cmap(round(end/2),:)/2);%,'EdgeAlpha',0.1);
    set(hpat,'EdgeColor','none');
...
%   set(hpat,'EdgeColor',cmap/2);%,'EdgeAlpha',0.1);
  set(hpat,'EdgeColor','none');
